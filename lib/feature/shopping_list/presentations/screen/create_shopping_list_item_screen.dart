...
class CreateShoppingListItemScreen extends HookWidget {
  const CreateShoppingListItemScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    final selectedProduct = useState<ProductOutput?>(null);
    ...
    final labelInputController = useTextEditingController();
    final quantityInputController = useTextEditingController();
    final selectedProductController = useTextEditingController();
